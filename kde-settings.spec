...
cp -f %{SOURCE1} usr/share/kde-settings/kde-profile/default/share/config/
...
%changelog
* Thu Feb  2 2011 Arkady L. Shane <ashejn@russianfedora.ru> 4.3.1-1.R
- enable kxkb indicator
